            ...
            <ul className="text-center flex flex-col items-center space-y-2">
              <li className="flex items-center">
                ...
                <div className="h-full">
                  <h2 className="text-lg font-bold my-0">Whatsapp</h2>
                  <a
                    href="https://api.whatsapp.com/send/?phone=%2B919956309404&text&type=phone_number&app_absent=0"
                    target="_blank"
              ...
              <li className="flex items-center">
                ...
                <div className="h-full">
                  ...
                  <a
                    href="https://www.linkedin.com/in/shadab-husain-5307b8231"
                    target="_blank"
                    className="text-blue-500 text-sm hover:text-blue-400 "
                  >
                    /Shadab Husain
              ...
              <li className="flex items-center">
                ...
                <div className="h-full">
                  ...
                  <a
                    href="https://github.com/Shadab0072"
                    target="_blank"
                    className="text-blue-500 text-sm hover:text-blue-400 "
                  >
                    /Shadab Husain
